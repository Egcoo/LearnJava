...
public class MyPanel extends JPanel implements KeyListener,Runnable {
    ...
    public MyPanel() {
        ...
        for (int i = 0; i < enemyTankSize; i++) {
            ...
            //4.1.2 给enemyTank 加入一颗子弹
            shot shot = new shot(enemyTank.getX() + 25, enemyTank.getY() + 70, enemyTank.getDirect());
            //4.1.3  加入enemyTank 的 vector 成员
        ...
        for (int i = 0; i < enemyTanks.size(); i++) {
            ...
            for (int j = 0; j < enemyTank.shots.size(); j++) {
                ...
                if (shot.isLive){
                    ...
                    g.draw3DRect(shot.x,shot.y,8,8,false);
                }else {
                    //从 vector 删除
