...
import com.HCMS.dao.DiningTableDAO;
import com.HCMS.domain.DiningTable;
...
public class DiningTableService {
    ...
    public List<DiningTable> list() {
        List<DiningTable> diningTable = diningTableDAO.queryMulti("select id, state from diningTable", DiningTable.class);
        return diningTable;
    }
    ...
    // 如果没有预定，调用方法，对其状态进行更新（包括预定人的名字和电话）
