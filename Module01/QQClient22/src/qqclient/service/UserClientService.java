...
public class UserClientService {
    ...
    public boolean checkUser(String userId, String pwd) {
        ...
        try {
            ...
            if (ms.getMesType().equals(MessageType.MESSAGE_LOGIN_SUCCEED)) { // 登录OK
                ...
                // 需要创建和服务器端保持通讯的线程 -> 一个类 ClientConnectServerThread
                //等待....
    ...
    public void onlineFriendList() {
        ...
        // 应该得到当前线程Socket 对应的 ObjectOutputStream 对象
        try {
            ObjectOutputStream oos = new ObjectOutputStream(socket.getOutputStream());
    ...
    //编写方法，退出客户端，并给服务端发送一个退出系统的message 对象
    public void logout(){
        Message message = new Message();
        message.setMesType(MessageType.MESSAGE_CLIENT_EXIT);
        message.setSender(u.getUserId()); // 一定要指定这是哪个客户端的 id
