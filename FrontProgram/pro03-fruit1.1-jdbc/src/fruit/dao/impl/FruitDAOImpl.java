...
public class FruitDAOImpl implements FruitDAO {
    ...
    /*
    改进方向：虽然目前只有一张表使用到下面四行的信息，但是在实际生产过程中，是有很多表的
    都需要用到这几个信息，所以这些信息仍旧可以向上提取。
    如果有OrderImplement 订单表、用户表、都需要用到
     */
    final String DRIVER = "com.mysql.jdbc.Driver" ;
    final String URL = "jdbc:mysql://localhost:3306/itheima?useUnicode=true&characterEncoding=utf-8&useSSL=false";
